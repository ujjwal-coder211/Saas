...
| Page | URL |
|------|-----|
| Home / Landing | `/web/index.html` |
| Aksh Studio (IDE) | `/web/studio/` |
| Dashboard | `/web/dashboard/` |
| Quick Chat | `/web/chat.html` |
...
- Getting started: `/web/docs/GETTING_STARTED.html`
- Full checklist for operators: `docs/USER_CHECKLIST.md`
