#!/usr/bin/env python3
"""
After Colab training — register new Omni brain as candidate (not active yet).

Example:
  python brain_register.py omni-v2 lora_hf \\
    --label "Omni v2" \\
...
from omni_training.brain_registry import register_version, update_metrics


def main() -> int:
    p = argparse.ArgumentParser(description="Register trained Omni brain as candidate")
    p.add_argument("version_id", help="e.g. omni-v2")
