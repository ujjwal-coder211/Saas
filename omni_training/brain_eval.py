#!/usr/bin/env python3
"""
M1 — Pre-promote checklist for Omni brain candidates.
...
def evaluate(version_id: str | None = None) -> dict:
    ...
    return {
        ...
        "checks": checks,
        "promote_command": f"python omni_training/brain_promote.py {target_id} --approve",
    }
...
def main() -> int:
    p = argparse.ArgumentParser(description="Omni brain pre-promote checklist")
