"""
Phase 3 — SFT dataset + Phase 3b — research dataset for Omni v2+ training.

Research file includes model behavior vectors so new Omni versions learn
...
def _behavior_system_prompt(row: dict) -> str:
    ...
    return (
        "You are Omni. Respond using patterns learned from expert models. "
