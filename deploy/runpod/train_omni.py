#!/usr/bin/env python3
"""Omni Conductor — RunPod training script (QLoRA on Nemotron-Nano-30B).

Standalone version of deploy/colab/OMNI_CONDUCTOR_TRAIN.md, driven entirely by
...
Optional env (sensible defaults):
  ...
  DATA_PATH        default: omni_training/data/export/conductor_v1_train.jsonl
  ADAPTER_REPO     default: Ujjwal211/aitotech-omni-v2
  ...
  OUTPUT_DIR       default: omni_conductor_lora

Run:  python deploy/runpod/train_omni.py
"""
...
def main() -> int:
    ...
    data_path = _env("DATA_PATH", "omni_training/data/export/conductor_v1_train.jsonl")
    adapter_repo = _env("ADAPTER_REPO", "Ujjwal211/aitotech-omni-v2")
    ...
    output_dir = _env("OUTPUT_DIR", "omni_conductor_lora")
    ...
    print("=" * 60)
    print("Omni Conductor — RunPod training")
