#!/usr/bin/env python3
"""
Promote trained Sarva brain → active main brain (hot replace).

Example:
  python brain_promote.py sarva-v2
  python brain_promote.py sarva-v2 --approve   # sets manual_approved=true then promotes
  python brain_promote.py sarva-v2 --force     # skip score check (emergency)
"""
...
def main() -> int:
    p = argparse.ArgumentParser(description="Promote Sarva candidate brain to active")
