"""
Interaction logger — captures USER signals + MODEL behavior for Sarva research.
...
from sarva_training.model_analyzer import (
    analyze_model_behavior,
    analyze_satisfaction,
    research_notes_for_row,
)
from sarva_training.schema import ResponsePattern, TrainingRow
...
def _apply_feedback_to_raw(row_id: str, patch: dict) -> bool:
    ...
    for row in rows:
        if row.get("row_id") == row_id:
            ...
            from sarva_training.model_analyzer import analyze_satisfaction, research_notes_for_row
            from sarva_training.schema import ModelBehaviorProfile, SatisfactionSignals
