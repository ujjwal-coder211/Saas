...
Creates sarva_training/data/colab_export/ with train JSONL + manifest.
"""
...
from sarva_training.vault import RESEARCH_OUTPUT_PATH, TRAIN_OUTPUT_PATH
...
def export_colab_bundle(*, zip_output: bool = True) -> dict:
    ...
    manifest = {
        ...
        "colab_steps": [
            ...
            "Run SFT on sarva_v1_train.jsonl",
            "Push adapter to HuggingFace",
            "On local: python sarva_training/brain_register.py sarva-vN lora_hf ...",
            "python sarva_training/brain_eval.py sarva-vN",
            "python sarva_training/brain_promote.py sarva-vN --approve",
        ],
    }
