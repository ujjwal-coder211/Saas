"""
Model behavior analyzer — research layer for Sarva Training Program.

Studies HOW each model answers (capability, style, structure), not just
the user question. Output feeds curated rows + research dataset for new Sarva versions.
"""
...
from sarva_training.schema import ModelBehaviorProfile, ResponsePattern, SatisfactionSignals
