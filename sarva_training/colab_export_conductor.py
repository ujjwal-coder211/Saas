...
Creates sarva_training/data/colab_export/ with train JSONL + manifest + Colab instructions.
"""
...
def export_colab_bundle(*, use_full: bool = True, zip_output: bool = True) -> dict:
    ...
    colab_manifest = {
        ...
        "adapter_start": "Ujjwal211/aitotech-sarva-v1",
        "adapter_push": "Ujjwal211/aitotech-sarva-v2",
        "colab_steps": [
            "Upload colab_export.zip to Colab",
            "Open deploy/colab/SARVA_CONDUCTOR_TRAIN.md and run cells",
            "Train on conductor_v1_train.jsonl",
            "Push adapter to HuggingFace",
            "brain_register.py sarva-v2 → brain_promote after RunPod deploy",
        ],
    }
