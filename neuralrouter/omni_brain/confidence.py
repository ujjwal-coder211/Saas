"""Omni confidence-based self-routing (paper v4 §3.3).

Ported from the saira_harvest Phase-1 `omni/confidence.py`. Omni asks itself
...
# Signals that push confidence UP — simple, well-scoped tasks Omni can do alone.
SIMPLE_SIGNALS = [
...
def self_assess(query: str, task_type: str = "general", historical: float | None = None) -> float:
    """Confidence in [0,1] that Omni can answer this well on its own.
